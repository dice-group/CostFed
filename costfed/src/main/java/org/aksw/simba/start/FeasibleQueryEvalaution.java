...
public class FeasibleQueryEvalaution {
    static final Logger log = LoggerFactory.getLogger(FeasibleQueryEvalaution.class);
    /**
    ...
    public static void main(String[] args) throws Exception {
        ...
        // String results =
        // "D:/BigRDFBench/completeness_correctness/results.n3";
        // ResultsLoader.loadResults(results);
        // SailRepository repo =
        // FedXFactory.initializeSparqlFederation(endpoints);
        ...
        for (int i = 1; i < queries.length; i++) {
            ...
            try {
                ...
                log.error("error in running query. processing bypassed ..", ex);
                bw.write(" error in running query. processing bypassed ..\n");
            }
        ...
        // System.out.println("Total Number of Records: " + count+"\n");
        // }
        // System.out.println(StatsGenerator.getFscores("D:/workspace/BigRDFBench-Utilities/results/"+queryNo,
        // query.evaluate()));
        // System.out.println("Missing:" +
        // StatsGenerator.getMissingResults("D:/workspace/BigRDFBench-Utilities/results/"+queryNo,
        // res));
        // FederationManager.getInstance().shutDown();
        // System.out.println("Done. Results written into results/"+args[1]);
        // bw.close();
        // String logDir = "D:/BigRDFBench/endpoints/logs/";
        // System.out.println("Endpoint requests:" +
        // RequestCount.getTotalEndpointRequests(logDir));
